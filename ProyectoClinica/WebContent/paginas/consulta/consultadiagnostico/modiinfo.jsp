...
String query="select *"; 
query += "from tconsultadiagnostico where idconsultadiag = '"+id_consulta+"' limit 1";
...
<tr><td colspan=1 ALIGN="left"> observacion</td><td><INPUT TYPE="text"  NAME="observacion" value ="<%=rs.getString(4)%>"></td></tr>
<%
...
<tr><td colspan=1 ALIGN="left"> diagnostico </td> <td> <select name="diagnostico">
