...
String query="SELECT * "; 
query += "FROM tconsultasintomas WHERE estado ='5'";
...
<td><a href="modiinfo.jsp?id_consulta=<%=rs.getString(1)%>&id_diagnostico=<%=rs.getString(3)%>&observacion=<%=rs.getString(7)%>&id_paciente=<%=rs.getString(5)%>">--</a></td>
