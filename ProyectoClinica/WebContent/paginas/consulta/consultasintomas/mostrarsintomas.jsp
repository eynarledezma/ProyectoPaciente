...
String query="SELECT   `tconsultasintomas`.`idconsultasintomas`, `tconsultasintomas`.`idconsulta`, `tconsultasintomas`.`idsintomas`, `tconsultasintomas`.`fecha`, `tconsultasintomas`.`idusuario`, `tconsultasintomas`.`observacion`"; 
query += "FROM tconsultasintomas where idconsulta = '"+id_consulta+"' limit 1";
