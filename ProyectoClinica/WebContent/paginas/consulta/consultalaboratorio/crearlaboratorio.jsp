...
String query2="select idlaboratorio,descripcion "; 
...
<h1 align="center">Crear laboratorios</h1>
<hr>
...
<tr><td colspan=1 ALIGN="left"> laboratorio </td> <td> <select name="labs">
...
<div id="boton">
<input id="boton1" type="submit" value="guardar laboratorios" />
</div>
<br>
</form>
