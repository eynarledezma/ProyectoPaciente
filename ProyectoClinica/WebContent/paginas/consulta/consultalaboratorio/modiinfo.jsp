...
String query="select *"; 
query += "from tconsultalaboratorio where idconlab = '"+id_consulta+"' limit 1";

String query2="select *"; 
query2 += "from tlaboratorios";
...
<tr><td colspan=1 ALIGN="left"> observacion</td><td><INPUT TYPE="text"  NAME="observacion" value ="<%=rs.getString(5)%>"></td></tr>
<%
...
<tr><td colspan=1 ALIGN="left"> laboratorios </td> <td> <select name="laboratorio">
