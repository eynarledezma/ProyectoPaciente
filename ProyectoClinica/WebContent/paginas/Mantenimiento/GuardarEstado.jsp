...
<%
	...
	String sql="insert into testados (descripcion,entidad,eliminado) values ('"+descripcion+"','"+entidad+"','"+eliminado+"')";
...
%> 
 ...
 <% 
String site = new String("../Mantenimiento/conf_estado.jsp");
