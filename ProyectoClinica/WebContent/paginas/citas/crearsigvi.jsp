...
<%
String id_usuario="";
id_usuario=(request.getParameter("id_usuario") != null) ? request.getParameter("id_usuario") : "";
...
<tr><td colspan=1 ALIGN="left"> id_paciente</td><td><INPUT TYPE="text" NAME="id_paciente" value ="<%=id_usuario%>"></td></tr>
